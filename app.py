...
class ProductView(db.Model):                                           #analytics 
    ...
    viewed_at = db.Column(db.DateTime(timezone=True),default=lambda: datetime.now(timezone.utc))                               #shows when product was viewed at  
                                                                                                                                #lambda: each row gets correct current time
...
def view_product(product_id):
    ...
    new_view = ProductView(product_id=product.id)
